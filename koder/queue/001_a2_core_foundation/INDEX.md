...
- rollover: coordinator `02` reached its four-entry cap including the `S04` coverage tooling pretask; coordinator `03b` recovered `S07` review/fix/re-review and may continue at `S08` while within cap/time.
